...
class Window:
    def __init__(self):
        ...
        self.root.configure(bg='#2196F3')  # Set background color
    ...
    def label1(self):
        self.lab1 = tk.Label(
            ...
            bg="#ff00d0")  # Set label background color
    ...
    def listbox(self):
        self.lv = tk.Variable()
        self.lst = tk.Listbox(self.root, listvariable=self.lv, height=10, selectbackground='#00a5ff')  # Set listbox height and selection color
        self.lst.pack(side=tk.LEFT, fill=tk.BOTH, expand=1)

    def label2(self):
        self.label = tk.Label(self.root, text="Press enter to add an item",
            bg="#ae00ff")  # Set label background color
...
class PackageInstaller:
    ...
    def show_calendar(self):
        cal = Calendar(self.window.root,  month=1, selectmode="day", year=2023, day=1, bg='#282828', fg='white')
        cal.pack()
